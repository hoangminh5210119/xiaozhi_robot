...
private:
  ...
  void InitializeTools() {
    ...
    storage.addSlot(0, GPIO_NUM_1); // Ô 0
    storage.addSlot(1, GPIO_NUM_1); // Ô 1  
    storage.addSlot(2, GPIO_NUM_1); // Ô 2
    storage.addSlot(3, GPIO_NUM_1); // Ô 3
    storage.addSlot(4, GPIO_NUM_1); // Ô 4
    storage.addSlot(5, GPIO_NUM_1); // Ô 5
